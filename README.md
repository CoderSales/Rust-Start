...
`notes on running` (or go to this online link: [notes on running](https://github.com/CoderSales/Rust-Start#notes-on-running))
...
<kbd>Ctrl</kbd><kbd>'</kbd> (Control apostrophe)
